...
const VideoCard = ({ video }) => {
  ...
  return (
    <div className="rounded overflow-hidden shadow-lg h-fit">
        ...
        <div className="px-6 py-4">
            <span className="inline-flex bg-lime-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">
                {video.likes}
            ...
            <span className="inline-flex bg-amber-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">
                {video.unlikes}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="ml-2 w-5 h-5">
