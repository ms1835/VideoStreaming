...
const Video = () => {
    ...
    useEffect(() => {
        getVideoDetails();
        if(userData?.subscribedTo?.some(channel => channnel?.id === video?.creator?._id)){
    ...
    return (
        ...
        <div>
            ...
            <div className="px-6 py-2">
                ...
                <button onClick={subscribeChannel} className={`${isSubscribed ? "bg-rose-500" : "bg-slate-500 hover:bg-slate-600" } text-white px-4 py-2 rounded-full`}>
